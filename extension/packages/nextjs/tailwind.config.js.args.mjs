export const tailwindImports = 'import path from "path";';
export const additionalContent = "path.join(path.dirname(require.resolve('@coinbase/onchainkit')), '**/*.js')";
export const themeExtend = `fill: {
